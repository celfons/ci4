...
$this->set_js_config($this->default_theme_path . '/bootstrap/js/jquery-plugins/config/jquery.noty.config.js');
?>
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title"> <?php echo $this->l('form_add'); ?> <?php echo $subject ?></span>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-3 col-sm-2">
                            <button class="btn btn-default btn-success b10 col-sm-12 col-xs-12 mt5" type="submit" id="form-button-save">
                        ...
                        <div class="col-sm-3">
                            <?php if (!$this->unset_back_to_list) { ?>
                                <button class="btn btn-info b10 col-sm-12 col-xs-12 mt5" type="button" id="save-and-go-back-button">
                        ...
                        <div class="col-sm-2">
                            <?php if (!$this->unset_back_to_list) { ?>
                                <button class="btn btn-default cancel-button b10 col-sm-12 col-xs-12 mt5" type="button" id="cancel-button">
